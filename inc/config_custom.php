...
define('SMS_USER', '***REMOVED***');
define('SMS_PASS', '***REMOVED***');
define('SMS_FROM', "031583610");
$SMS_TO = array("031583610");

define('MAILGUN_KEY', '***REMOVED***');
define('MAILGUN_DOMAIN', '***REMOVED***');
define('MAILGUN_FROM', 'ParlaParser <***REMOVED***>'); //Excited User <YOU@YOUR_DOMAIN_NAME>

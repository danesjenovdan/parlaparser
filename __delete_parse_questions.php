...
function parseQuestionStart($urls, $startPage)
{
...
//	$string = html_entity_decode($in, ENT_QUOTES, 'UTF-8');
$string = html_entity_decode($in, ENT_COMPAT, 'UTF-8');
    //mb_internal_encoding('utf-8');

//    $b = preg_replace("/&#(\d{2,5});/e", "unichr($1);", $in);
    //$c = str_replace("\xA0", ' ', $b);

//$string = iconv('ASCII', 'UTF-8//IGNORE', $b);
...
parseQuestionStart(array('http://www.dz-rs.si/wps/portal/Home/deloDZ/poslanskaVprasanjaInPobude/'), 3);

...
PZ8.xml
http://fotogalerija.dz-rs.si/datoteke/opendata/PZ8.XML
...
- Akti - konec postopka
PA8.xml
http://fotogalerija.dz-rs.si/datoteke/opendata/PA8.XML
...
function searchInAllSections($unid, $session_id, $datum, $data){
    ...
    $searchInMe[] = 'xml/PZ8.XML';
    $searchInMe[] = 'xml/SZ.XML';
    $searchInMe[] = 'xml/PA.XML';
    $searchInMe[] = 'xml/PA8.XML';
...
//continue;
                if ($motionId) {
                    $id = insertVotingDocument($motionId, 1, $session_id, $date, $motionName, $items);
                    print_r("inserted: ");
                    print_r($id);
                } else {
                    print_r("nogo");
